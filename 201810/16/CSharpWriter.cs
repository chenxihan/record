    ...
    public class CSharpWriter
    {
        ...
        public static void WriteDataDeclareCSEx(string declareDir, string dataDir, DataTable dt, List<ColumnInfo> fieldTypeRawAry)
        {
            try
            {
                ...
                //File.Copy(fileH, "Assets/Plugins/FuncellDeclare/Declare"+ formatedTableUpName + ".cs");
                //File.Copy(file2, "Assets/StreamingAssets/ua/Config/Data"+ formatedTableUpName + ".lua");
            }
            catch (Exception ex)
            {
