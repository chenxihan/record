...
namespace DLLComplierEditor
{
    ...
    public class CSharpWriter
    {
        ...
        private static string GetDeclareString(DataTable dt, string TableUpName, List<ColumnInfo> fieldTypeRawAry)
        {
            ...
            sb.AppendLine("    {");
            sb.AppendLine("         System.IO.FileStream fs = new System.IO.FileStream(\"E:/OldConfig.txt\", System.IO.FileMode.OpenOrCreate, System.IO.FileAccess.ReadWrite);");
        ...
        //获取字段的值
        private static string GenFieldValueString(object rowObj, ColumnInfo fInfo, string className)
        {
            string tempValue = "0";
            ...
            if (rowObj != null)
            {
                ...
                {
                    tempValue = ProcessStringDefines(value, className);   
                }
            }
            return tempValue;
        }
        ...
        //处理字符串定义
        private static string ProcessStringDefines(string val, string className)
        {
            ...
            lock (_allTexts)
            {
                ...
                tempValue = "StringDefines.Key_" + idx;
                return tempValue;
            }
        }
