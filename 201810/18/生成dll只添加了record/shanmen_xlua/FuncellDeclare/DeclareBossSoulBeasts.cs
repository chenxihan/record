//文件是自动生成,请勿手动修改.来自数据文件:bossSoulBeasts
using System;
using System.Collections.Generic;
using XLua;
namespace Funcell.Cfg.Data
{
  [global::System.Serializable, global::ProtoBuf.ProtoContract(Name=@"DeclareBossSoulBeasts")]
  public class DeclareBossSoulBeasts
  {
    #region //私有变量定义
    //boss等级
    ...
    [global::ProtoBuf.ProtoMember(16, IsRequired = true, Name=@"Power", DataFormat = global::ProtoBuf.DataFormat.TwosComplement)]
    ...
    //填充数据回调
    public delegate void OnFillDataHandler(Dictionary<int, DeclareBossSoulBeasts> data);
    private static OnFillDataHandler _fillDataCallBack = null;
    //数据存储字典
    private static Dictionary<int, DeclareBossSoulBeasts> _dataCaches = null;
    public static Dictionary<int, DeclareBossSoulBeasts> CacheData
    {
        get 
        {
            lock (_lockObj)
    ...
    //根据ID获取数据
    public static DeclareBossSoulBeasts Get(int id)
    {
        lock (_lockObj)
        {
            SetData();
    ...
    //transForm函数，作数据填充
    public static void Transform(Dictionary<int, DeclareBossSoulBeasts> data)
    {
        lock (_lockObj)
        {
            _dataCaches = data;
