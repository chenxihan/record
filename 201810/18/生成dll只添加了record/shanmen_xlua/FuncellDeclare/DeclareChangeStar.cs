...
{
  [global::System.Serializable, global::ProtoBuf.ProtoContract(Name=@"DeclareChangeStar")]
  public class DeclareChangeStar
  {
    #region //私有变量定义
    //基础成长属性(属性类型_增加的值)(@;@_@)
    private string _att;
    ...
    [global::ProtoBuf.ProtoMember(7, IsRequired = true, Name=@"ParentId", DataFormat = global::ProtoBuf.DataFormat.TwosComplement)]
    public int ParentId { get{ return _parentId; } set{ _parentId=value; } }
    [global::ProtoBuf.ProtoMember(8, IsRequired = true, Name=@"Rune", DataFormat = global::ProtoBuf.DataFormat.TwosComplement)]
    public int Rune { get{ return _rune; } set{ _rune=value; } }
    [global::ProtoBuf.ProtoMember(9, IsRequired = true, Name=@"Steps", DataFormat = global::ProtoBuf.DataFormat.TwosComplement)]
    public int Steps { get{ return _steps; } set{ _steps=value; } }
    [global::ProtoBuf.ProtoMember(10, IsRequired = true, Name=@"UpNeedExp", DataFormat = global::ProtoBuf.DataFormat.TwosComplement)]
    ...
    //填充数据回调
    public delegate void OnFillDataHandler(Dictionary<int, DeclareChangeStar> data);
    private static OnFillDataHandler _fillDataCallBack = null;
    //数据存储字典
    private static Dictionary<int, DeclareChangeStar> _dataCaches = null;
    public static Dictionary<int, DeclareChangeStar> CacheData
    {
        get 
        {
            lock (_lockObj)
    ...
    //根据ID获取数据
    public static DeclareChangeStar Get(int id)
    {
        lock (_lockObj)
        {
            SetData();
    ...
    //transForm函数，作数据填充
    public static void Transform(Dictionary<int, DeclareChangeStar> data)
    {
        lock (_lockObj)
        {
            _dataCaches = data;
