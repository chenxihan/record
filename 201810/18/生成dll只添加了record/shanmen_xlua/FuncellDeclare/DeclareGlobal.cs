...
{
  [global::System.Serializable, global::ProtoBuf.ProtoContract(Name=@"DeclareGlobal")]
  public class DeclareGlobal
  {
    ...
    [global::ProtoBuf.ProtoMember(2, IsRequired = true, Name=@"Params", DataFormat = global::ProtoBuf.DataFormat.Default)]
    ...
    //填充数据回调
    public delegate void OnFillDataHandler(Dictionary<int, DeclareGlobal> data);
    ...
    //transForm函数，作数据填充
    public static void Transform(Dictionary<int, DeclareGlobal> data)
    {
        lock (_lockObj)
        {
            _dataCaches = data;
