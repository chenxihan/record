...
{
  [global::System.Serializable, global::ProtoBuf.ProtoContract(Name=@"DeclareGuildQuestion")]
  public class DeclareGuildQuestion
  {
    #region //私有变量定义
    //正确答案
    ...
    //填充数据回调
    public delegate void OnFillDataHandler(Dictionary<int, DeclareGuildQuestion> data);
    private static OnFillDataHandler _fillDataCallBack = null;
    //数据存储字典
    private static Dictionary<int, DeclareGuildQuestion> _dataCaches = null;
    public static Dictionary<int, DeclareGuildQuestion> CacheData
    {
        get 
        {
            lock (_lockObj)
    ...
    //根据ID获取数据
    public static DeclareGuildQuestion Get(int id)
    {
        lock (_lockObj)
        {
            SetData();
    ...
    //transForm函数，作数据填充
    public static void Transform(Dictionary<int, DeclareGuildQuestion> data)
    {
        lock (_lockObj)
        {
            _dataCaches = data;
