...
{
  [global::System.Serializable, global::ProtoBuf.ProtoContract(Name=@"DeclareKingAllianceLevel")]
  public class DeclareKingAllianceLevel
  {
    #region //私有变量定义
    ...
    #region //公共属性
    [global::ProtoBuf.ProtoMember(1, IsRequired = true, Name=@"DayJoinAward", DataFormat = global::ProtoBuf.DataFormat.Default)]
    public string DayJoinAward { get{ return _day_join_award; } set{ _day_join_award=value; } }
    [global::ProtoBuf.ProtoMember(2, IsRequired = true, Name=@"Degree", DataFormat = global::ProtoBuf.DataFormat.TwosComplement)]
    ...
    [global::ProtoBuf.ProtoMember(4, IsRequired = true, Name=@"LoseFeatsValue", DataFormat = global::ProtoBuf.DataFormat.TwosComplement)]
    public int LoseFeatsValue { get{ return _lose_feats_value; } set{ _lose_feats_value=value; } }
    [global::ProtoBuf.ProtoMember(5, IsRequired = true, Name=@"LoseScore", DataFormat = global::ProtoBuf.DataFormat.TwosComplement)]
    ...
    [global::ProtoBuf.ProtoMember(7, IsRequired = true, Name=@"NeedScore", DataFormat = global::ProtoBuf.DataFormat.TwosComplement)]
    public int NeedScore { get{ return _need_score; } set{ _need_score=value; } }
    [global::ProtoBuf.ProtoMember(8, IsRequired = true, Name=@"ResIcon", DataFormat = global::ProtoBuf.DataFormat.TwosComplement)]
    public int ResIcon { get{ return _res_icon; } set{ _res_icon=value; } }
    [global::ProtoBuf.ProtoMember(9, IsRequired = true, Name=@"ResTex", DataFormat = global::ProtoBuf.DataFormat.Default)]
    public string ResTex { get{ return _res_tex; } set{ _res_tex=value; } }
    [global::ProtoBuf.ProtoMember(10, IsRequired = true, Name=@"StarNum", DataFormat = global::ProtoBuf.DataFormat.TwosComplement)]
    public int StarNum { get{ return _star_num; } set{ _star_num=value; } }
    [global::ProtoBuf.ProtoMember(11, IsRequired = true, Name=@"WinFeatsValue", DataFormat = global::ProtoBuf.DataFormat.TwosComplement)]
    public int WinFeatsValue { get{ return _win_feats_value; } set{ _win_feats_value=value; } }
    [global::ProtoBuf.ProtoMember(12, IsRequired = true, Name=@"WinSocre", DataFormat = global::ProtoBuf.DataFormat.TwosComplement)]
    ...
    //填充数据回调
    public delegate void OnFillDataHandler(Dictionary<int, DeclareKingAllianceLevel> data);
    private static OnFillDataHandler _fillDataCallBack = null;
    //数据存储字典
    private static Dictionary<int, DeclareKingAllianceLevel> _dataCaches = null;
    public static Dictionary<int, DeclareKingAllianceLevel> CacheData
    {
        get 
        {
            lock (_lockObj)
    ...
    //根据ID获取数据
    public static DeclareKingAllianceLevel Get(int id)
    {
        lock (_lockObj)
        {
            SetData();
    ...
    //transForm函数，作数据填充
    public static void Transform(Dictionary<int, DeclareKingAllianceLevel> data)
    {
        lock (_lockObj)
        {
            _dataCaches = data;
