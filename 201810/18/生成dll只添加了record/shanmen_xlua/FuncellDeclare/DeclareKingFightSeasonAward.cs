...
{
  [global::System.Serializable, global::ProtoBuf.ProtoContract(Name=@"DeclareKingFightSeasonAward")]
  public class DeclareKingFightSeasonAward
  {
    #region //私有变量定义
    //奖励(@;@_@)
    ...
    //填充数据回调
    public delegate void OnFillDataHandler(Dictionary<int, DeclareKingFightSeasonAward> data);
    private static OnFillDataHandler _fillDataCallBack = null;
    //数据存储字典
    private static Dictionary<int, DeclareKingFightSeasonAward> _dataCaches = null;
    public static Dictionary<int, DeclareKingFightSeasonAward> CacheData
    {
        get 
        {
            lock (_lockObj)
    ...
    //根据ID获取数据
    public static DeclareKingFightSeasonAward Get(int id)
    {
        lock (_lockObj)
        {
            SetData();
    ...
    //transForm函数，作数据填充
    public static void Transform(Dictionary<int, DeclareKingFightSeasonAward> data)
    {
        lock (_lockObj)
        {
            _dataCaches = data;
