...
{
  [global::System.Serializable, global::ProtoBuf.ProtoContract(Name=@"DeclareMarriagePatron")]
  public class DeclareMarriagePatron
  {
    #region //私有变量定义
    //激活一次所需好感度
    ...
    //填充数据回调
    public delegate void OnFillDataHandler(Dictionary<int, DeclareMarriagePatron> data);
    private static OnFillDataHandler _fillDataCallBack = null;
    //数据存储字典
    private static Dictionary<int, DeclareMarriagePatron> _dataCaches = null;
    public static Dictionary<int, DeclareMarriagePatron> CacheData
    {
        get 
        {
            lock (_lockObj)
    ...
    //根据ID获取数据
    public static DeclareMarriagePatron Get(int id)
    {
        lock (_lockObj)
        {
            SetData();
    ...
    //transForm函数，作数据填充
    public static void Transform(Dictionary<int, DeclareMarriagePatron> data)
    {
        lock (_lockObj)
        {
            _dataCaches = data;
