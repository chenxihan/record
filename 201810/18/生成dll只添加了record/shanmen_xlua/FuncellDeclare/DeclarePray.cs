...
{
  [global::System.Serializable, global::ProtoBuf.ProtoContract(Name=@"DeclarePray")]
  public class DeclarePray
  {
    ...
    //填充数据回调
    public delegate void OnFillDataHandler(Dictionary<int, DeclarePray> data);
    ...
    //transForm函数，作数据填充
    public static void Transform(Dictionary<int, DeclarePray> data)
    {
        lock (_lockObj)
        {
            _dataCaches = data;
