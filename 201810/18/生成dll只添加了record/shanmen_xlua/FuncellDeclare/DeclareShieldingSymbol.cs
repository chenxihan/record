...
{
  [global::System.Serializable, global::ProtoBuf.ProtoContract(Name=@"DeclareShieldingSymbol")]
  public class DeclareShieldingSymbol
  {
    #region //私有变量定义
    //ID
    private int _id;
    ...
    //填充数据回调
    public delegate void OnFillDataHandler(Dictionary<int, DeclareShieldingSymbol> data);
    private static OnFillDataHandler _fillDataCallBack = null;
    //数据存储字典
    private static Dictionary<int, DeclareShieldingSymbol> _dataCaches = null;
    public static Dictionary<int, DeclareShieldingSymbol> CacheData
    {
        get 
        {
            lock (_lockObj)
    ...
    //根据ID获取数据
    public static DeclareShieldingSymbol Get(int id)
    {
        lock (_lockObj)
        {
            SetData();
    ...
    //transForm函数，作数据填充
    public static void Transform(Dictionary<int, DeclareShieldingSymbol> data)
    {
        lock (_lockObj)
        {
            _dataCaches = data;
