...
using DLLComplierEditor.Encryption;
#endif

using DLLComplierEditor.Core;
using DLLComplierEditor.Checksums;
using DLLComplierEditor.Zip.Compression.Streams;
using DLLComplierEditor.Zip.Compression;

namespace DLLComplierEditor.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="DLLComplierEditor.Zip.ZipException">
