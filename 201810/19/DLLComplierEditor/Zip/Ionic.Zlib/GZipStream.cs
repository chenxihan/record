...
namespace DLLComplierEditor
{
    ...
    ///   <c>DLLComplierEditor.GZipStream</c> can compress while writing, or decompress while
    ...
    public class GZipStream : System.IO.Stream
    {
        ...
        ///     {
        ///         using (Stream decompressor= new DLLComplierEditor.GZipStream(input, CompressionMode.Decompress, true))
        ///         {
        ...
        ///         Using decompressor As Stream = new DLLComplierEditor.GZipStream(input, CompressionMode.Decompress, True)
        ...
        public override long Position
        {
            get
            {
                if (this._baseStream._streamMode == DLLComplierEditor.ZlibBaseStream.StreamMode.Writer)
                    return this._baseStream._z.TotalBytesOut + _headerByteCount;
                if (this._baseStream._streamMode == DLLComplierEditor.ZlibBaseStream.StreamMode.Reader)
        ...
        {
            if (_disposed) throw new ObjectDisposedException("GZipStream");
            if (_baseStream._streamMode == DLLComplierEditor.ZlibBaseStream.StreamMode.Undefined)
            {
