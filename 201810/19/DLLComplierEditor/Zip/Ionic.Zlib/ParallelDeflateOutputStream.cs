...
namespace DLLComplierEditor
{
    internal class WorkItem
    {
        ...
        public WorkItem(int size,
                        DLLComplierEditor.CompressionLevel compressLevel,
    ...
    ///
    /// <para>
    ///   This class is similar to <see cref="DLLComplierEditor.DeflateStream"/>, except
    ...
    ///
    /// </remarks>
    /// <seealso cref="DLLComplierEditor.DeflateStream" />
    public class ParallelDeflateOutputStream : System.IO.Stream
    {
        ...
        private int                         _Crc32;
        private DLLComplierEditor.CRC32             _runningCrc;
        ...
        private DLLComplierEditor.CompressionLevel _compressLevel;
        ...
        ///
        /// <para>
        ///   This class is similar to <see cref="DLLComplierEditor.DeflateStream"/>,
        ...
        ///   cref="DLLComplierEditor.DeflateStream"/>.  On the other hand, using a
        ...
        private void _InitializePoolOfWorkItems()
        {
            ...
            _runningCrc = new DLLComplierEditor.CRC32();
            _currentlyFilling = -1;
            _lastFilled = -1;
            _lastWritten = -1;
            _latestCompressed = -1;
        ...
        ///
        /// <para>
        ///   To decompress data, use the <see cref="DLLComplierEditor.DeflateStream"/> class.
        /// </para>
        ///
        /// </remarks>
        ...
        private void _PerpetualWriterMethod(object state)
        {
            ...
            try
            {
                do
                {
                    ...
                    DLLComplierEditor.CRC32 c= new DLLComplierEditor.CRC32();
                    do
                    {
        ...
        private void _DeflateOne(Object wi)
        {
            ...
            try
            {
                ...
                DLLComplierEditor.CRC32 crc = new DLLComplierEditor.CRC32();
